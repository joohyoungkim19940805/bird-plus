...
public class MailService {
    ...
    @Async
    public void sendForgotPasswordEmail(AccountEntity user, String templateName, String title) {
        //LOGGER.debug("Sending login OTP email to '{}'", user.getEmail());
        sendEmailFromTemplate(user, "content/mail/forgotPasswordTemplate", "hellow wrod");
    }
}
