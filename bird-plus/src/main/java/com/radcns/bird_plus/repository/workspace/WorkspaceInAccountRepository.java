...
public interface WorkspaceInAccountRepository extends ReactiveCrudRepository<WorkspaceInAccountEntity, Long> {
	...
	@Query("""
			...
			;
			""")
	Flux<WorkspaceMembersDomain.WorkspaceInAccountListResponse> //like 문 추가 할 예정
		findAllJoinAccountByWorkspaceIdAndNotAccountId(Long workspaceId, Long accountId, Pageable pageble);
	...
	@Query("""
			...
			""")
	Mono<Long>
		countJoinAccountByWorkspaceIdAndNotAccountId(Long workpsaceId, Long accountId);
	...
	@Query("""
			...
			""")
	Flux<WorkspaceMembersDomain.WorkspaceInAccountListResponse> //like 문 추가 할 예정
		findAllJoinAccountByWorkspaceIdAndNotAccountIdAndFullName(Long workspaceId, Long accountId, String fullName, Pageable pageble);
	...
	@Query("""
			...
			""")
	Mono<Long>
		countJoinAccountByWorkspaceIdAndNotAccountIdAndFullName(Long workpsaceId, Long accountId, String fullName);
